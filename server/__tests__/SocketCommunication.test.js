...
describe("SocketCommunication edge cases", () => {
    ...
    describe("onJoinRoom edge cases", () => {
        ...
        test("should handle game already started", () => {
            ...
            expect(mockSocket.emit).toHaveBeenCalledWith("gameAlreadyStarted", {
                message: "The game in this room has already started ! Please reload to try to join again.",
            });
            expect(mockSocket.leave).toHaveBeenCalledWith("startedRoom");
        });

        test("should handle name already taken", () => {
            const connectionHandler = socketCommunication.io.listeners("connection")[0];
            connectionHandler(mockSocket);
            ...
            expect(mockSocket.emit).toHaveBeenCalledWith("nameTaken", {
                message: "This name is already taken. Please choose another one.",
            });
            expect(gameWithPlayer.addPlayer).not.toHaveBeenCalled();
        });
        ...
        test("should send room counter to new player during countdown", () => {
            ...
            expect(gameInCountdown.addPlayer).toHaveBeenCalledWith("socket123", "Player1", false);
            expect(mockSocket.emit).toHaveBeenCalledWith("roomCounter", { timeLeft: 5 });
    ...
    describe("onGameLost edge cases", () => {
        test("should handle game with multiple players remaining", () => {
            ...
            socketCommunication.gameMap.set("multiPlayerRoom", gameWithMultiplePlayers);
            ...
            expect(consoleSpy).toHaveBeenCalledWith("Game lost for socket", "socket123");
        ...
        test("should handle game with one player remaining", () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith("Game lost for socket", "socket123");
            expect(consoleSpy).toHaveBeenCalledWith("END OF GAME FOR ROOM", "singlePlayerRoom");
    ...
    describe("onDisconnect edge cases", () => {
        test("should handle disconnect with started game", () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith("Deleting game:", "startedGameRoom");
        ...
        test("should handle disconnect with no game/player found", () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith("[socket] disconnected:", "socket123", "no game disconnect");
            // Should not crash
